...
class VLLMHijack:
    ...
    def hijack():
        def hijack__load_adapter(self, lora_request: TensorLoRARequest) -> LoRAModel:
            ...
            Adds support for loading a LoRA adapter directly from in-memory tensors.
            """
        ...
        if vs.parse(version("vllm")).base_version == "0.11.0":
            ...
            def hijack__get_mm_mapping(self) -> MultiModelKeys:
                """
                Patch vLLM 0.11.0 Qwen3-VL module prefixes so LoRA filtering
                sees the real module names used by Hugging Face.
                """
